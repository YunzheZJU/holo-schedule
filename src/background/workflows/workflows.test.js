...
test('should extract title', async () => {
  ...
  expect(workflows.extractTopic({ title: '≪Topic≫Title' })).toEqual('topic')
  expect(workflows.extractTopic({ title: '【Topic】【Title】' })).toEqual('topic')
  expect(workflows.extractTopic({ title: '【Topic]abc】Title' })).toEqual('topic')
  expect(workflows.extractTopic({ title: '【 T#1 o 444p55＃5ic 】 Title' })).toEqual('topic')
  expect(workflows.extractTopic({ title: '【#Topic】Title' })).toEqual('topic')
  expect(workflows.extractTopic({ title: '【Topic #11】Title' })).toEqual('topic')
  expect(workflows.extractTopic({ title: '【#1】【Topic】Title' })).toEqual('topic')
  expect(workflows.extractTopic({ title: '【#1】【Topic2000】Title【Name】' })).toEqual('topic')
})
